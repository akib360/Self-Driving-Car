...
def findTrafficSign():
    ...
    while True:
        ...
        for(x,y,w,h) in stop:
            ...
            cv2.putText(frame, 'Stop', (x-w+190,y-5), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 128, 255), 4, cv2.CV_AA)
        ...
        if largestArea > frameArea*0.02:
            ...
            cv2.drawContours(frame,[largestRect],0,(0, 128, 255),2)
	    ...
	    # write the description of the sign on the original image
            cv2.putText(frame, detectedTrafficSign, (100, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 128, 255), 4)
